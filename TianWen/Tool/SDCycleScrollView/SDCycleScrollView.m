...
-(void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView{
    ...
    if (self.souceType == 1) {
        [[NSNotificationCenter defaultCenter] postNotificationName:@"scrollToSelectRollPicture1" object:[NSString stringWithFormat:@"%d",indexOnPageControl]];
    }else{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"scrollToSelectRollPicture" object:[NSString stringWithFormat:@"%d",indexOnPageControl]];
    }
