...
//    toolBar.backgroundColor = CZHColor(0xf6f6f6);
    ...
    UIButton *cancleButton = [UIButton czh_buttonWithTarget:self action:@selector(buttonClick:) frame:CGRectMake(0, 0, TOOLBAR_BUTTON_WIDTH, toolBar.czh_height - 1) titleColor:CZHColor(0x9C9C9C) titleFont:CZHGlobelNormalFont(16) title:@"取消"];
    cancleButton.tag = CZHAddressPickerViewButtonTypeCancle;
    [toolBar addSubview:cancleButton];

//    UILabel *titleLabel = [UILabel labelWithTitle:@"" color:[UIColor hexStringToColor:@"#0f0f0f"]  fontSize:18.0 alignment:NSTextAlignmentCenter];
    UILabel *titleLabel = [UILabel new];
    [titleLabel setTextColor:[UIColor hexStringToColor:@"#0C0C0C"]];
    titleLabel.font = [UIFont systemFontOfSize:18.0];
    [titleLabel setTextAlignment:NSTextAlignmentCenter];
    
    titleLabel.frame = CGRectMake(TOOLBAR_BUTTON_WIDTH + 5.0, 0, toolBar.czh_width - 2 * TOOLBAR_BUTTON_WIDTH - 2 * 5.0, toolBar.czh_height - 1);
...
//    UIButton *sureButton = [UIButton czh_buttonWithTarget:self action:@selector(buttonClick:) frame:CGRectMake(toolBar.czh_width - TOOLBAR_BUTTON_WIDTH, 0, TOOLBAR_BUTTON_WIDTH, toolBar.czh_height) titleColor:CZHThemeColor titleFont:CZHGlobelNormalFont(18) title:@"确定"];
    UIButton *sureButton = [UIButton czh_buttonWithTarget:self action:@selector(buttonClick:) frame:CGRectMake(toolBar.czh_width - TOOLBAR_BUTTON_WIDTH, 0, TOOLBAR_BUTTON_WIDTH, toolBar.czh_height - 1) titleColor:[UIColor hexStringToColor:@"#49CA6D"] titleFont:CZHGlobelNormalFont(16) title:@"确定"];
    sureButton.tag = CZHAddressPickerViewButtonTypeSure;
    [toolBar addSubview:sureButton];
    
    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(0, toolBar.czh_height - 1, ScreenWidth, 1)];
...
- (void)showView {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        self.backgroundColor = CZHRGBColor(0x000000, 0.5);
